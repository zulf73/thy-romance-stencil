 ...
 */
export interface ContextComponent<P, S, C extends React.Component<P, S> | React.StatelessComponent<P>> extends React.Component<P, S> {
 ...
 */
export interface ContextComponentClass<P, S, C extends React.Component<P, S> | React.StatelessComponent<P>, ComponentClass extends React.ComponentClass<P>> extends React.ComponentClass<P> {
 ...
 */
export interface DropTargetSpec<P, S, TargetComponent extends React.Component<P, S> | React.StatelessComponent<P>> {
    /**
     * Optional.
...
export interface DragSourceSpec<P, S, TargetComponent extends React.Component<P, S> | React.StatelessComponent<P>, DragObject> {
    /**
     * Required.
...
export declare type DragElementWrapper<O> = <P>(elementOrNode: React.ReactElement<P> | Element, options?: O) => React.ReactElement<P>;
...
export declare type ConnectDropTarget = <P>(elementOrNode: React.ReactElement<P>) => React.ReactElement<P>;
